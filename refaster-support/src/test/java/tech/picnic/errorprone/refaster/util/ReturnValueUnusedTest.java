...
final class ReturnValueUnusedTest {
  ...
  /** A {@link BugChecker} which simply delegates to {@link ReturnValueUnused}. */
  @BugPattern(summary = "Flags expressions of which the return value is unused", severity = ERROR)
