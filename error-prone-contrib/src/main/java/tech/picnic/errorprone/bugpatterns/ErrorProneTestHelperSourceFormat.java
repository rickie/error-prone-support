...
public final class ErrorProneTestHelperSourceFormat extends BugChecker
  ...
  // XXX: If text block are not officially supported _yet present_, then the code is likely compiled
  // with Jabel (or similar) enabled. See https://github.com/bsideup/jabel.
